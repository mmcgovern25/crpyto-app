...
const bannerStyles = "h-96 rounded-2xl bg-cover bg-center flex flex-col justify-around w-full";
const containerStyles = "h-full flex flex-col justify-center items-center space-y-";
